                    ...
                    <form id="auth-form" onsubmit="handleLogin(event)" class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative flex justify-center text-xs">
                                <span class="${styles.cardBg} px-2 ${styles.textSecondary}">hoặc</span>
                            </div>
                        </div>

                        <button type="button" onclick="firebaseLoginWithGoogle()" class="w-full border ${styles.border} ${styles.textPrimary} hover:${styles.glass} text-white font-semibold rounded-lg py-3 shadow-sm transition-colors flex items-center justify-center gap-2 bg-white hover:bg-gray-50">
